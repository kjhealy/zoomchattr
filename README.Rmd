...
zoomchattr takes the directory of Zoom chat files that's been accumulating on your computer for the past two years, parses them either individually or _en masse_, and makes them into a tibble with one chat message per row.
...
At present the `from` column has both the "From" and "To" information in it. It also includes any Direct Messages sent to the person recording the chat. 
